describe("Tests our home inputs", function () {
    ...
    it("adds texts to inputs", function () {
      cy.get('[data-cy="name"]').type("Melissa Longenberger").should("have.value", "Melissa Longenberger");
      cy.get('[data-cy="email"]')
        .type("melissalongenberger24@gmail.com")
        .should("have.value", "melissalongenberger24@gmail.com");
    });
  });
